            ...
            <div className="border-l-2 border-black/5 dark:border-white/5 ml-4 sm:ml-6 space-y-12 sm:space-y-16 mb-20">
              {EXPERIENCE_DATA.map((exp, idx) => (
                <div key={idx} className="relative pl-8 sm:pl-12 group">
                  ...
                  <div className="text-accent text-sm sm:text-base font-bold mb-6 flex items-center gap-2">
                    {exp.company} <span className="text-gray-300 dark:text-gray-700">•</span> <span className="text-gray-500 font-medium">{exp.location}</span>
                  </div>
