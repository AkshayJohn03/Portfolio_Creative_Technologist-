...
export const CASE_STUDIES: Record<string, CaseStudyContent> = {
  ...
  'ux-storyboard': {
    ...
    overview: 'This storyboard outlines a calm, one-to-one thermal experimental session with a blind adult who has no visual memory of light or dark. The goal is to build an intuitive understanding of "shadow" as an absence or blockage that creates noticeable contrast in the environment.',
    context: 'The goal is not scientific precision but to build an intuitive understanding using senses they already rely on deeply: touch, temperature, sound, proprioception, and spatial awareness.',
    techStack: [
      { category: 'Props & Tools', tools: ['Strong Directional Lamp', 'Fan', 'Warm Objects', 'Cardboard Screen'] },
      { category: 'Goals', tools: ['Sensory Translation', 'Empathy-Driven Design', 'Observation to Agency'] },
      { category: 'Setting', tools: ['Quiet Indoor Room', 'Adjustable Lighting'] },
    ],
    challenges: [
      { title: 'Sensory Translation', description: 'Mapping the visual phenomenon of light blockage onto physical sensations of temperature and airflow without overwhelming the participant.' },
      { title: 'Empathy-Driven Design', description: 'Ensuring the explainer operates entirely within the participant\'s sensory world, modeling empathy (e.g., optional blindfolds for the explainer).' },
      { title: 'Observation to Agency', description: 'Shifting the participant from passively feeling a drop in temperature to actively creating and manipulating their own "thermal silhouette."' },
    ],
    uiGallery: [],
  },
  'ux-lifelink': {
    ...
    title: 'Lifelink Systems',
    role: 'Product Designer',
    overview: 'A complete healthcare system application designed to streamline and manage various aspects of patient transfers, communication among healthcare professionals, and overall patient management. The application consists of multiple modules, each catering to specific functions essential for efficient healthcare operations.',
    techStack: [
      { category: 'Modules', tools: ['Patient Transfers', 'Communication', 'Patient Management', 'Analytics'] },
